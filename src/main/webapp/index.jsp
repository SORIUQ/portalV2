	...
	<div class="contenedor">
		<article class="menu">
			<div class="menuOpciones">
				...
				<div class="menuOpcion" onclick="cambiarContenido('jsp/centro.jsp')">
					<svg xmlns="http://www.w3.org/2000/svg" width="125" height="125"
						viewBox="0 0 24 24">
						<path fill="#a100ff"
				...
				<div class="menuOpcion" onclick="cambiarContenido('jsp/modulo.jsp')">
					<svg xmlns="http://www.w3.org/2000/svg" width="125" height="125"
						viewBox="0 0 24 24">
						<path fill="#a100ff"
				...
				<div class="menuOpcion" onclick="cambiarContenido('jsp/tutoria.jsp')">
					<svg xmlns="http://www.w3.org/2000/svg" width="125" height="125"
						viewBox="0 0 24 24">
						<path fill="#a100ff"
				...
				%>
				<div class="menuOpcion" onclick="cambiarContenido('jsp/calificaciones.jsp')">
					<svg xmlns="http://www.w3.org/2000/svg" width="125" height="125"
						viewBox="0 0 24 24">
						<path fill="#a100ff"
				...
				<div class="menuOpcion" onclick="cambiarContenido('jsp/datosPersonales.jsp')">
					<svg xmlns="http://www.w3.org/2000/svg" width="125" height="125"
						viewBox="0 0 24 24">
						<path fill="#a100ff"
...
<script>
	...
	function selectedMenu(id){
		/*remove selected if already exists*/
		let element;
		for (let i = 0; i < 6; i++){
