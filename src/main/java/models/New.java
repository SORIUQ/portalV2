...
public class New {
	 ...
	 */
	public New(int id, String title, String caption, String imagen, String captionImagen, String content,
			String creationDate) {
		super();
		this.id = id;
		this.title = title;
	 ...
	 * @param creationDate  fecha de publicacion de la noticia
	 */
	public New(int id, String title, String caption, String content, String creationDate) {
		super();
		this.id = id;
		this.title = title;
		this.caption = caption;
